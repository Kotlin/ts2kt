...
public object TS {
    ...
    public trait NodeArray<T> : JsArray<T>, TextRange {
        public var hasTrailingComma: Boolean? // = noImpl
    }

    public trait ModifiersArray : NodeArray<Node> {
        public var flags: Number
    }

    public trait Identifier : PrimaryExpression {
        public var text: String
    }

    public trait EntityName : Identifier, QualifiedName
    public trait DeclarationName : Identifier, LiteralExpression, ComputedPropertyName

    public trait QualifiedName : Node {
        public var left: EntityName
        public var right: Identifier
    }
    public trait Declaration : Node {
        public var _declarationBrand: Any
        native("name")
        public val declarationName: DeclarationName? // = noImpl
    }
    public trait ComputedPropertyName : Node {
        public var expression: Expression
    }
    public trait TypeParameterDeclaration : Declaration {
        public var name: Identifier
        public var constraint: TypeNode? // = noImpl
        public var expression: Expression? // = noImpl
    }
        public trait SignatureDeclaration : Declaration {
    ...
    public trait VariableDeclaration : Declaration {
        public var name: Identifier
        public var type: TypeNode? // = noImpl
        public var initializer: Expression? // = noImpl
    }

    trait TypeNode_or_StringLiteralExpression : TypeNode, StringLiteralExpression

    public trait ParameterDeclaration : Declaration {
    ...
    public trait PropertyDeclaration : Declaration, ClassElement {
        public var _propertyDeclarationBrand: Any
        public var questionToken: Node? // = noImpl
        public var type: TypeNode? // = noImpl
        public var initializer: Expression? // = noImpl
    }
    public trait ObjectLiteralElement : Declaration {
        public var _objectLiteralBrandBrand: Any
    }
    public trait ShorthandPropertyAssignment : ObjectLiteralElement {
        public var name: Identifier
        public var questionToken: Node? // = noImpl
    }
    public trait PropertyAssignment : ObjectLiteralElement {
    ...
    trait Block_or_Expression : Block, Expression

    public trait FunctionLikeDeclaration : SignatureDeclaration {
    ...
    public trait FunctionDeclaration : FunctionLikeDeclaration, Statement {
        public var name: Identifier
        public var body: Block? // = noImpl
    }
    public trait MethodDeclaration : FunctionLikeDeclaration, ClassElement, ObjectLiteralElement {
        //TODO extra space
        public  var body: Block? // = noImpl
    }
    public trait ConstructorDeclaration : FunctionLikeDeclaration, ClassElement {
        public  var body: Block? // = noImpl
    }
    public trait AccessorDeclaration : FunctionLikeDeclaration, ClassElement, ObjectLiteralElement {
        public var _accessorDeclarationBrand: Any
        public var body: Block
    }
    public trait IndexSignatureDeclaration : SignatureDeclaration, ClassElement {
        public var _indexSignatureDeclarationBrand: Any
    }
    public trait TypeNode : Node {
        public var _typeNodeBrand: Any
    }
    public trait FunctionOrConstructorTypeNode : TypeNode, SignatureDeclaration {
        public var _functionOrConstructorTypeNodeBrand: Any
    }
    public trait TypeReferenceNode : TypeNode {
        public var typeName: EntityName
        public var typeArguments: NodeArray<TypeNode>? // = noImpl
    }
    public trait TypeQueryNode : TypeNode {
        public var exprName: EntityName
    }
    public trait TypeLiteralNode : TypeNode, Declaration {
        public var members: NodeArray<Node>
    }
    public trait ArrayTypeNode : TypeNode {
        public var elementType: TypeNode
    }
    public trait TupleTypeNode : TypeNode {
        public var elementTypes: NodeArray<TypeNode>
    }
    public trait UnionTypeNode : TypeNode {
        public var types: NodeArray<TypeNode>
    }
    public trait ParenthesizedTypeNode : TypeNode {
        public var type: TypeNode
    }
    public trait Expression : Node {
        public var _expressionBrand: Any
        public var contextualType: Type? // = noImpl
    }
    public trait UnaryExpression : Expression {
        public var _unaryExpressionBrand: Any
    }
    public trait PrefixUnaryExpression : UnaryExpression {
        public var operator: SyntaxKind
        public var operand: UnaryExpression
    }
    public trait PostfixUnaryExpression : PostfixExpression {
        public var operand: LeftHandSideExpression
        public var operator: SyntaxKind
    }
    public trait PostfixExpression : UnaryExpression {
        public var _postfixExpressionBrand: Any
    }
    public trait LeftHandSideExpression : PostfixExpression {
        public var _leftHandSideExpressionBrand: Any
    }
    public trait MemberExpression : LeftHandSideExpression {
        public var _memberExpressionBrand: Any
    }
    public trait PrimaryExpression : MemberExpression {
        public var _primaryExpressionBrand: Any
    }
    public trait DeleteExpression : UnaryExpression {
        public var expression: UnaryExpression
    }
    public trait TypeOfExpression : UnaryExpression {
        public var expression: UnaryExpression
    }
    public trait VoidExpression : UnaryExpression {
        public var expression: UnaryExpression
    }
    public trait YieldExpression : Expression {
        public var asteriskToken: Node? // = noImpl
        public var expression: Expression
    }
    public trait BinaryExpression : Expression {
        public var left: Expression
        public var operator: SyntaxKind
        public var right: Expression
    }
    public trait ConditionalExpression : Expression {
        public var condition: Expression
        public var whenTrue: Expression
        public var whenFalse: Expression
    }
    public trait FunctionExpression : PrimaryExpression, FunctionLikeDeclaration {
        public var name: Identifier? // = noImpl
        native("body")
        override var myBody: Block_or_Expression
    }
    public trait LiteralExpression : PrimaryExpression {
        public var text: String
        public var isUnterminated: Boolean? // = noImpl
    }
    public trait StringLiteralExpression : LiteralExpression {
        public var _stringLiteralExpressionBrand: Any
    }
    public trait TemplateExpression : PrimaryExpression {
        public var head: LiteralExpression
        public var templateSpans: NodeArray<TemplateSpan>
    }
    public trait TemplateSpan : Node {
        public var expression: Expression
        public var literal: LiteralExpression
    }
    public trait ParenthesizedExpression : PrimaryExpression {
        public var expression: Expression
    }
    public trait ArrayLiteralExpression : PrimaryExpression {
        public var elements: NodeArray<Expression>
    }
    public trait ObjectLiteralExpression : PrimaryExpression, Declaration {
        public var properties: NodeArray<ObjectLiteralElement>
    }
    public trait PropertyAccessExpression : MemberExpression {
        public var expression: LeftHandSideExpression
        public var name: Identifier
    }
    public trait ElementAccessExpression : MemberExpression {
        public var expression: LeftHandSideExpression
        public var argumentExpression: Expression? // = noImpl
    }
    public trait CallExpression : LeftHandSideExpression {
        public var expression: LeftHandSideExpression
        public var typeArguments: NodeArray<TypeNode>? // = noImpl
        public var arguments: NodeArray<Expression>
    }
    public trait NewExpression : CallExpression, PrimaryExpression

    trait LiteralExpression_or_TemplateExpression : LiteralExpression, TemplateExpression

    public trait TaggedTemplateExpression : MemberExpression {
        public var tag: LeftHandSideExpression
        public var template: LiteralExpression_or_TemplateExpression
    }
    public trait TypeAssertion : UnaryExpression {
        public var type: TypeNode
        public var expression: UnaryExpression
    }
    public trait Statement : Node, ModuleElement {
        public var _statementBrand: Any
    }
    public trait Block : Statement {
        public var statements: NodeArray<Statement>
    }
    public trait VariableStatement : Statement {
        public var declarations: NodeArray<VariableDeclaration>
    }
    public trait ExpressionStatement : Statement {
        public var expression: Expression
    }
    public trait IfStatement : Statement {
        public var expression: Expression
        public var thenStatement: Statement
        public var elseStatement: Statement? // = noImpl
    }
    public trait IterationStatement : Statement {
        public var statement: Statement
    }
    public trait DoStatement : IterationStatement {
        public var expression: Expression
    }
    public trait WhileStatement : IterationStatement {
        public var expression: Expression
    }
    public trait ForStatement : IterationStatement {
    ...
    public trait ForInStatement : IterationStatement {
        public var declarations: NodeArray<VariableDeclaration>? // = noImpl
        public var variable: Expression? // = noImpl
        public var expression: Expression
    }
    public trait BreakOrContinueStatement : Statement {
        public var label: Identifier? // = noImpl
    }
    public trait ReturnStatement : Statement {
        public var expression: Expression? // = noImpl
    }
    public trait WithStatement : Statement {
        public var expression: Expression
        public var statement: Statement
    }
    public trait SwitchStatement : Statement {
        public var expression: Expression
        public var clauses: NodeArray<CaseOrDefaultClause>
    }
    public trait CaseClause : Node {
        public var expression: Expression? // = noImpl
        public var statements: NodeArray<Statement>
    }
    public trait DefaultClause : Node {
        public var statements: NodeArray<Statement>
    }

    public trait  CaseOrDefaultClause : CaseClause, DefaultClause

    public trait LabeledStatement : Statement {
        public var label: Identifier
        public var statement: Statement
    }
    public trait ThrowStatement : Statement {
        public var expression: Expression
    }
    public trait TryStatement : Statement {
        public var tryBlock: Block
        public var catchClause: CatchClause? // = noImpl
        public var finallyBlock: Block? // = noImpl
    }
    public trait CatchClause : Declaration {
        public var name: Identifier
        public var type: TypeNode? // = noImpl
        public var block: Block
    }
    public trait ModuleElement : Node {
        public var _moduleElementBrand: Any
    }
    public trait ClassDeclaration : Declaration, ModuleElement {
        public var name: Identifier
        public var typeParameters: NodeArray<TypeParameterDeclaration>? // = noImpl
        public var heritageClauses: NodeArray<HeritageClause>? // = noImpl
        public var members: NodeArray<ClassElement>
    }
    public trait ClassElement : Declaration {
        public var _classElementBrand: Any
    }
    public trait InterfaceDeclaration : Declaration, ModuleElement {
        public var name: Identifier
        public var typeParameters: NodeArray<TypeParameterDeclaration>? // = noImpl
        public var heritageClauses: NodeArray<HeritageClause>? // = noImpl
        public var members: NodeArray<Declaration>
    }
    public trait HeritageClause : Node {
        public var token: SyntaxKind
        public var types: NodeArray<TypeReferenceNode>? // = noImpl
    }
    public trait TypeAliasDeclaration : Declaration, ModuleElement {
        public var name: Identifier
        public var type: TypeNode
    }
    public trait EnumMember : Declaration {
        native("name")
        override var declarationName: DeclarationName
        public var initializer: Expression? // = noImpl
    }
    public trait EnumDeclaration : Declaration, ModuleElement {
        public var name: Identifier
        public var members: NodeArray<EnumMember>
    }

    trait Identifier_or_LiteralExpression : Identifier, LiteralExpression

    trait ModuleBlock_or_ModuleDeclaration : ModuleBlock, ModuleDeclaration

    public trait ModuleDeclaration : Declaration, ModuleElement {
        public var name: Identifier_or_LiteralExpression
        public var body: ModuleBlock_or_ModuleDeclaration
    }
    public trait ModuleBlock : Node, ModuleElement {
        public var statements: NodeArray<ModuleElement>
    }

    trait EntityName_or_ExternalModuleReference : EntityName, ExternalModuleReference

    public trait ImportDeclaration : Declaration, ModuleElement {
        public var name: Identifier
        public var moduleReference: EntityName_or_ExternalModuleReference
    }
    public trait ExternalModuleReference : Node {
        public var expression: Expression? // = noImpl
    }
    public trait ExportAssignment : Statement, ModuleElement {
        public var exportName: Identifier
    }
    public trait FileReference : TextRange {
        public var filename: String
    }
    public trait CommentRange : TextRange {
        public var hasTrailingNewLine: Boolean? // = noImpl
    }
    public trait SourceFile : Declaration {
        public var statements: NodeArray<ModuleElement>
    ...
    trait CallLikeExpression : CallExpression, NewExpression, TaggedTemplateExpression

    trait PropertyAccessExpression_or_QualifiedName : PropertyAccessExpression, QualifiedName

    public trait TypeChecker {
    ...
    public trait SymbolDisplayBuilder {
    ...
    public trait SymbolVisibilityResult {
    ...
    public trait SymbolAccessiblityResult : SymbolVisibilityResult {
        public var errorModuleName: String? // = noImpl
    }
    public trait EmitResolver {
//        public fun getProgram(): Program
...
//        public fun isEmitBlocked(sourceFile: SourceFile? = null): Boolean
    ...
    public trait TransientSymbol : Symbol, SymbolLinks
    ...
    public trait IntrinsicType : Type {
        public var intrinsicName: String
    }
    public trait StringLiteralType : Type {
        public var text: String
    }
    public trait ObjectType : Type
    public trait InterfaceType : ObjectType {
    ...
    public trait TypeReference : ObjectType {
        public var target: GenericType
        public var typeArguments: Array<Type>
    }
    public trait GenericType : InterfaceType, TypeReference {
    ...
    public trait TypeParameter : Type {
...
//        public fun set(option: String, value: Boolean)
    ...
    public trait ParsedCommandLine {
...
//    }
    ...
    public trait CancellationToken {
        public fun isCancellationRequested(): Boolean
    }
    public trait CompilerHost {
